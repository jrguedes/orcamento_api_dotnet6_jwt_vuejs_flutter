...
namespace orcamento_dotnet6_api.Controllers
{
    [ApiController]
    [Authorize]
    ...
    public class OrcamentoController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post([FromBody] Orcamento orcamento)
        {
            try
            {
        ...
        [HttpPut]
        [Authorize(Roles = "Gerente,Funcionario")]
        public async Task<ActionResult> Put([FromBody] Orcamento orcamento)
        {
            try
            {
